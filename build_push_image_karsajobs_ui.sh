# Melakukan build docker dengan nama ghcr.io/stazyu/karsajobs-ui dan tag latest
docker build -t ghcr.io/stazyu/karsajobs-ui:latest .
...
docker push ghcr.io/stazyu/karsajobs-ui:latest